...
user1 = User(1, 'Timur', 'Nishanbaev', 19, 'male')
user2 = User(2, 'Nyaz', 'Programmist', 23, 'male')
user3 = User(3, 'Gena', 'Dodik', 21, 'male')
data_obj.add_user(user1)
data_obj.add_user(user2)
data_obj.add_user(user3)
data_obj.send_message(user1, user2, 'Hello my friend')
data_obj.send_message(user2, user1, 'you too')
data_obj.send_message(user3, user1, 'I love u')
